  ...
  return (
    <header
      className="
        ...
        flex flex-col
        items-start gap-6 lg:gap-[49px]

        py-3 sm:py-4 lg:py-[30px]
    ...
    >
      ...
      <section className="shrink-0 flex flex-col items-start gap-5 p-0">
        <div>
          <h1 className="text-3xl sm:text-4xl lg:text-heading-1 leading-[105%] tracking-tight whitespace-pre-wrap">
        ...
        <div className="whitespace-nowrap wrap-break-word">
          <h1 className="text-sm text-subhead text-paragraph leading-[109%] whitespace-pre-wrap">
      ...
      <section className="flex shrink-0 items-start gap-3 w-full p-0 mb-2 lg:mb-0">
        <Link text="Contact" />
        <Link text="Social" />
        <Link text="Address" />
